    ...
    return (React.createElement(StyledModal, null,
        React.createElement(ModalHeader, null,
            React.createElement(ModalTitle, null,
                ...
                React.createElement(Heading, { style: { color: "#F8D901", textShadow: "0px 0px 10px #d3cb92", fontSize: "1.25rem" } }, title)),
...
var WalletCard = function (_a) {
    ...
    return (React.createElement(Button, { fullWidth: true, style: { justifyContent: "space-between", backgroundColor: "#000000", color: "#FFFFFF", lineHeight: "16px", fontSize: "0.88rem", boxShadow: "-0.16em -0.2em #FFFF00, 0.16em 0.2em #0000FF" }, onClick: function () {
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss }, connectors.map(function (entry, index) { return (React.createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "16px" : "0" })); })));
};
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(Button, { size: "sm", style: { backgroundColor: "#000000", color: "#FFFFFF", lineHeight: "16px", fontSize: "0.88rem", boxShadow: "-0.16em -0.2em #FFFF00, 0.16em 0.2em #0000FF" }, onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React.createElement(Button, { size: "sm", style: { backgroundColor: "#000000", color: "#FFFFFF", lineHeight: "16px", fontSize: "0.88rem", boxShadow: "-0.16em -0.2em #FFFF00, 0.16em 0.2em #0000FF" }, onClick: function () {
